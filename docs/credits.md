> Upstream's credits, reproduced here for attribution. This page is logisim-evolution's, not
> this port's; the people named below wrote the program this is a modified version of.

[**logisim-evolution**](https://github.com/logisim-evolution/logisim-evolution)

*(Upstream's logo is their trade mark and is not redistributed here; see `NOTICE.md`.)*
