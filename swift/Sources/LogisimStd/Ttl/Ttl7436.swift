// Ttl7436.swift: part of logisim-evolved.
//
// Derived from logisim-evolution (com.cburch.logisim.std.ttl.Ttl7436),
...
/// TTL 74x36: quad 2-input NOR gate. Same pin layout as `Ttl7400`/`Ttl7408`/`Ttl7432`.
public final class Ttl7436: AbstractTtlGate {

  /// `Ttl7436._ID`. "Unique identifier of the tool, used as reference in project files. Do NOT
  /// change as it will prevent project files from loading.", upstream's own comment.
  public static let id = "7436"

  private static let pinCount = 14
  private static let outPorts = [3, 6, 8, 11]

  public convenience init() {
    self.init(Ttl7436.id)
  }

  /// `Ttl7436(String name)`; unused within this file set, ported for parity with upstream's
  /// public constructor.
  public init(_ name: String) {
    super.init(
      name,
      pins: Ttl7436.pinCount,
      outputPorts: Ttl7436.outPorts,
      drawGates: true)
  }
  ...
  public override func paintInternal(
    ...
    Drawgates.paintOr(painter, x + 40, youtput, portwidth - 4, portheight, true, false)
